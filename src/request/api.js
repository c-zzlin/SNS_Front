...
export const queryNavMsg = p => post('/Msg/query_nav_msg', p);    //查询好友数量、动态数量
...
export const reply_child_insert =p =>post('/reply/child_insert', p)     //添加子回复
...
export const blog_upload =p =>post("/api/blog/uploadvcf", p)
